...
syms symT x1 x2 x3 x4 U1 U2 U3 time
vars = [x1,x2,x3,x4];
...
dynamics = [x2;
    1/Param.totalInertia*(Excite_forceSpectrum(time) - (Param.heaveMoorStiff+Param.hydrostaticCoeff)*x1 - Param.dragFactor*x3*(x2-U2)*abs(x2-U2) - (Param.C_r*[x4]+Param.D_r*x2));
    0;
    Param.A_r*[x4]+Param.B_r*x2];
