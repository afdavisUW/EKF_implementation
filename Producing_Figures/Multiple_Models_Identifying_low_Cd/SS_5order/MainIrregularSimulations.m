...
% Time.end = 12;
Time.end = 5;% max 1 period from the end of the timespan
...
% Initial Condtions 
Param.IC.est = [0.1, 0.1, 1,0,0,0,0,0];
Param.IC.real = [0, 0, 0.35, 0,0,0,0,0]; % parameters used when simulating 'data'
...
save('EKF5.mat','EKF','Measurements')
%%
...
subplot(2,1,2)
plot(EKF.time.t, Measurements(:,2), 'k', EKF.time.hat, EKF.y.hat(2,:),'b')
