...
syms symT x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 U1 U2 U3 time
...
N = 3;
dynamics = [x2;
    1/Param.totalInertia*(Excite_forceSpectrum(time) - (Param.heaveMoorStiff+Param.hydrostaticCoeff)*x1 - Param.dragFactor*x3*(x2-U2)*abs(x2-U2) - (Param.C_r*[x4;x5;x6;x7;x8;x9;x10;x11;x12;x13]+Param.D_r*x2));
    0.2*2.33/N*cos(2.33/N*time);
    Param.A_r*[x4;x5;x6;x7;x8;x9;x10;x11;x12;x13]+Param.B_r*x2];
